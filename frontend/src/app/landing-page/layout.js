export const metadata = {
  ...
  keywords: 'fruupy, free online calculators, BMI calculator, EMI calculator, age calculator, percentage calculator, QR code generator, language translator, meme generator, countdown timer, utility tools, online tools, free calculators, Fruupy tools, calculator tools, productivity tools',
  ...
  openGraph: {
    ...
    url: '/landing-page',
    siteName: 'Fruupy',
    images: [{ url: '/og-image.jpg', width: 1200, height: 630, alt: 'Free Online Calculators & Tools - Fruupy' }],
    locale: 'en_US',
    type: 'website',
  },
  twitter: {
