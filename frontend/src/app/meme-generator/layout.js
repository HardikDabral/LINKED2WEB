export const metadata = {
  title: 'Meme Generator - Create Custom Memes | Fruupy',
  ...
  keywords: 'fruupy, meme generator, create memes, meme maker, meme tool, custom memes, meme creator, funny memes, meme editor',
}
