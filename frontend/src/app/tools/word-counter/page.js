      ...
      <div className="max-w-4xl mx-auto px-4 pt-16">
        ...
        <div className="bg-white/30 backdrop-blur-xl rounded-3xl p-10 shadow-sm border border-[#0B2E33]/10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {[
              { name: 'Language Translator', href: '/tools/language-translator', desc: 'Translate 50+ languages' },
              { name: 'JSON Formatter', href: '/tools/json-formatter', desc: 'Beautify your code' },
              { name: 'Base64 Tool', href: '/tools/base64-tool', desc: 'Secure encode/decode' },
              { name: 'BMI Calculator', href: '/tools/bmi-calculator', desc: 'Check your health' },
              { name: 'GPA Calculator', href: '/tools/gpa-calculator', desc: 'Calculate your grades' },
              { name: 'QR Generator', href: '/tools/qr-generator', desc: 'Create custom QR codes' },
            ].map((tool) => (
              <Link
                key={tool.name}
                href={tool.href}
