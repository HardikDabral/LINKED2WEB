...
const faqs = [
  { q: "How much water should I drink daily?", a: "A common rule of thumb is 30–35 ml per kg of body weight. Our calculator refines this with activity and climate factors to suggest a personalised daily target." },
  { q: "Does water intake depend on weight?", a: "Yes. Larger bodies generally need more water to stay hydrated. The calculator uses your weight as the primary input and adjusts for activity on top." },
  { q: "Should I drink more if I exercise?", a: "Yes. Add roughly 350–500 ml per hour of moderate exercise, and more in hot or humid weather. The calculator accounts for common activity levels." },
  { q: "Do teas and fruit count toward my intake?", a: "Yes. Hydrating drinks and water-rich foods contribute to your daily total. Plain water is still the cleanest option and easiest to track." },
]
