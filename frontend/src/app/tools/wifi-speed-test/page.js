...
const faqs = [
  { q: "How is internet speed measured?", a: "We download and upload sample files to a nearby test server and time each transfer. The rates, expressed in Mbps, show how fast your connection sends and receives data." },
  { q: "What is a good internet speed?", a: "For HD streaming and video calls, 25 Mbps is comfortable. For 4K streaming, gaming, or multiple users, aim for 100+ Mbps. Upload matters too — 10 Mbps is a sensible minimum." },
  { q: "Why is my speed lower than my plan advertises?", a: "Distance from the router, Wi-Fi interference, old hardware, and network congestion all reduce throughput. Test on Ethernet to isolate Wi-Fi issues from ISP issues." },
  { q: "Does the test use data from my plan?", a: "Yes. A full test transfers tens of megabytes. On metered mobile data, run a shorter test or switch to unmetered Wi-Fi before testing." },
]
  ...
  <div className="max-w-2xl w-full mx-4 sm:mx-auto p-6 pt-16">
        ...
        <div className="mt-8 bg-white/50 backdrop-blur-xl rounded-xl p-6 shadow-md border border-[#93B1B5]/40">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <Link href="/tools/json-formatter" className="text-[#0B2E33] hover:text-[#4F7C82] transition-colors text-sm">
              → JSON Formatter
            </Link>
