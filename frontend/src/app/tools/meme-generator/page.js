...
const faqs = [
  { q: "Can I upload my own image?", a: "Yes. Upload any PNG or JPG, then add top and bottom text. The image is processed in your browser — nothing is uploaded to a server." },
  { q: "Can I add more than one text line?", a: "Yes — both top and bottom captions are supported. For more lines, resize and reposition text using the available controls." },
  { q: "How do I download the finished meme?", a: "After you’re happy with the result, click the Download button to save the meme as a PNG to your device." },
  { q: "Who owns the memes I make?", a: "You are responsible for the content you create. Only use images you have rights to, and avoid uploading copyrighted or private photos you don’t own." },
]
