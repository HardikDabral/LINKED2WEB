...
const faqs = [
  { q: "How do I add or remove GST from a price?", a: "Enter the amount and GST rate; the tool shows both the GST-exclusive and GST-inclusive totals so you can move either direction in one step." },
  { q: "What GST rates does India use?", a: "The common GST slabs are 0%, 5%, 12%, 18% and 28%. The correct slab depends on the product or service category — check the latest CBIC notification if unsure." },
  { q: "Is GST added before or after a discount?", a: "In India, GST is charged on the discounted (net) price when the discount is recorded on the invoice. Apply the discount first, then calculate GST on the reduced amount." },
  { q: "Does the calculator split CGST and SGST?", a: "For intra-state supplies, GST is split equally between CGST and SGST. Our tool computes the total GST; you can halve it to get CGST/SGST, or treat the full value as IGST for inter-state supply." },
]
