export const metadata = {
  ...
  alternates: {
    canonical: '/tools/expense-splitter',
  },
  openGraph: {
    title: 'Expense Splitter - Split Bills & Expenses | Fruupy',
...
export default function ExpenseLayout({ children }) {
  ...
  const structuredData = {
    ...
    "url": `${baseUrl}/tools/expense-splitter`,
  ...
  const breadcrumbData = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Expense Splitter", "item": `${baseUrl}/tools/expense-splitter` }
    ]
  }
