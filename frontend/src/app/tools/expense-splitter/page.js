...
const faqs = [
  { q: "How do I split a bill evenly among friends?", a: "Enter the total amount and the number of people — the tool returns an equal share per person, rounded to the nearest paisa/cent." },
  { q: "Can I handle uneven shares?", a: "Yes. Instead of a simple split, enter individual contributions or weights so the calculator balances who owes whom." },
  { q: "Does it save my group for later?", a: "Splits are calculated in your browser and not stored on a server. Bookmark the page or note down the result to keep a record." },
  { q: "Can I split a tip too?", a: "Use our tip calculator first to compute the tip, then feed the post-tip total into the splitter for an accurate per-person share." },
]
