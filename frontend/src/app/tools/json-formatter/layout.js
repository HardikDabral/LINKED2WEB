export const metadata = {
  title: 'JSON Formatter - Format & Validate JSON | Fruupy',
  ...
  keywords: 'fruupy, JSON formatter, JSON validator, JSON beautifier, format JSON, JSON tool, JSON parser, JSON editor, JSON viewer',
}
