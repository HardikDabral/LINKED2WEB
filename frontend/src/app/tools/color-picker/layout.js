export const metadata = {
  title: 'Color Picker - Free Color Picker Tool | Fruupy',
  ...
  keywords: 'fruupy, color picker, color tool, HEX color, RGB color, HSL color, color converter, color palette, color codes',
...
export default function ColorLayout({ children }) {
  ...
  const breadcrumbData = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Color Picker", "item": `${baseUrl}/tools/color-picker` }
    ]
  }
