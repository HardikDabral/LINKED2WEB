...
const faqs = [
  { q: "Which color formats does the picker output?", a: "It returns HEX, RGB and HSL values for every selection so you can paste directly into CSS, design tools or documentation without conversion." },
  { q: "How do I convert HEX to RGB?", a: "Pick any color and the tool shows its HEX, RGB, and HSL side by side — just copy the format you need. You can also type a HEX value to see its RGB equivalent instantly." },
  { q: "What is HSL and when should I use it?", a: "HSL stands for Hue, Saturation, Lightness. It maps closer to how humans describe color, making it easier to create tints, shades, and consistent color systems than adjusting RGB values directly." },
  { q: "Can I pick a color from an image?", a: "This tool lets you sample from a color wheel or enter a value. For pixel-accurate sampling from an image, use your OS screen picker first, then paste the HEX value here to get RGB/HSL." },
]
      ...
      <div className="max-w-2xl w-full mx-4 sm:mx-auto p-6 pt-16">
        ...
        <div className="mt-8 bg-white/50 backdrop-blur-xl rounded-xl p-6 shadow-md border border-[#93B1B5]/40">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <Link href="/tools/meme-generator" className="text-[#0B2E33] hover:text-[#4F7C82] transition-colors text-sm">
              → Meme Generator
            </Link>
            <Link href="/tools/qr-generator" className="text-[#0B2E33] hover:text-[#4F7C82] transition-colors text-sm">
              → QR Generator
            </Link>
