...
const faqs = [
  { q: "What is a typical tip percentage?", a: "Standard service tips are 10–15% in most countries, 15–20% in the US, and 5–10% at cafés or self-service spots. Adjust up or down based on service quality and local norms." },
  { q: "How do I split a tip among a group?", a: "Enter the bill, tip percentage and number of people. The tool shows the total tip, the full bill, and the per-person share so everyone pays equally." },
  { q: "Is tax included in the tip?", a: "Conventionally, tip is calculated on the pre-tax subtotal. The calculator lets you choose whether to tip on the pre-tax or post-tax amount." },
  { q: "What if the service was bad?", a: "Tipping is discretionary. Lower the percentage or skip the tip, but consider the local culture — in some countries service charges are already added to the bill." },
]
  ...
  <div className="max-w-2xl w-full mx-4 sm:mx-auto p-6 pt-16">
        ...
        <div className="mt-8 bg-white/50 backdrop-blur-xl rounded-xl p-6 shadow-md border border-[#93B1B5]/40">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link href="/tools/expense-splitter" className="text-[#0B2E33] hover:text-[#4F7C82] transition-colors text-sm">
              → Expense Splitter
            </Link>
            <Link href="/tools/discount-calculator" className="text-[#0B2E33] hover:text-[#4F7C82] transition-colors text-sm">
              → Discount Calculator
            </Link>
