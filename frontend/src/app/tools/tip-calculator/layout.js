export const metadata = {
  title: 'Tip Calculator - Calculate Tips & Gratuity | Fruupy',
  ...
  keywords: 'fruupy, tip calculator, gratuity calculator, tip tool, calculate tip, restaurant tip, service tip, tip percentage, tip splitter, free tip calculator, gratuity tool',
...
export default function TipLayout({ children }) {
  ...
  const breadcrumbData = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Tip Calculator", "item": `${baseUrl}/tools/tip-calculator` }
    ]
  }
