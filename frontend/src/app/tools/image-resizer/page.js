...
const faqs = [
  { q: "Which image formats are supported?", a: "PNG, JPG/JPEG and WebP are fully supported. Very large formats and some RAW camera files may not load — convert them to a standard format first." },
  { q: "Does resizing reduce image quality?", a: "Downscaling loses detail that cannot be recovered. The tool uses high-quality browser scaling, but for prints or banners always keep the original as a backup." },
  { q: "Are my images uploaded to your server?", a: "No. Resizing runs entirely in your browser using the Canvas API — the image never leaves your device." },
  { q: "Can I keep the aspect ratio when resizing?", a: "Yes. Lock the aspect ratio and change only width or height; the other dimension updates automatically so the image doesn’t stretch." },
]
