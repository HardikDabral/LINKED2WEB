export const metadata = {
  title: 'Salary Calculator - Calculate Take Home Salary | Fruupy',
  ...
  keywords: 'fruupy, salary calculator, take home salary, salary tool, net salary, gross salary, salary after tax, income calculator, pay calculator',
}
