...
const faqs = [
  { q: "How is take-home pay calculated?", a: "Take-home is your gross salary minus standard deductions such as income tax, provident fund, professional tax and any other company-specific cuts you enter." },
  { q: "Does it include PF and ESI?", a: "Yes, when you enter the relevant rates. The calculator lets you toggle provident fund and other statutory deductions to match your country or employer." },
  { q: "Can I compare CTC vs in-hand salary?", a: "Yes. Enter your CTC and the calculator breaks it into fixed pay, variable pay, deductions and net in-hand, so you know what actually reaches your account." },
  { q: "Is tax calculated for my country?", a: "Tax rules differ by country and slab. Enter the applicable tax percentage for your bracket; the calculator then applies it to the taxable portion of your salary." },
]
