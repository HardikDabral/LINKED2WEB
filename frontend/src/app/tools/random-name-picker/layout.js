export const metadata = {
  title: 'Random Name Picker - Pick Random Names | Fruupy',
  ...
  keywords: 'fruupy, random name picker, name picker, random selector, name generator, random choice, pick names, random tool, name selector',
}
