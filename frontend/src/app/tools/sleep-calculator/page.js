...
const faqs = [
  { q: "What is a sleep cycle?", a: "A sleep cycle is roughly 90 minutes long and moves through light sleep, deep sleep and REM stages. Waking at the end of a cycle feels easier than waking mid-cycle." },
  { q: "How many cycles should I aim for per night?", a: "Most adults feel rested after 5–6 cycles (about 7.5–9 hours). Teenagers and children need more; older adults may do well with slightly less." },
  { q: "Why does the calculator suggest specific bedtimes?", a: "It works backward from your wake time in 90-minute increments, then adds 15 minutes for falling asleep, so you wake near the end of a cycle feeling refreshed." },
  { q: "Does a short nap count toward the total?", a: "Naps help with short-term alertness but don’t replace night-time cycles. Keep naps under 30 minutes to avoid grogginess from waking mid-deep-sleep." },
]
  ...
  <div className="max-w-2xl w-full mx-4 sm:mx-auto p-6 pt-16">
        ...
        <div className="mt-8 bg-white/50 backdrop-blur-xl rounded-xl p-6 shadow-md border border-[#93B1B5]/40">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <Link href="/tools/calorie-calculator" className="text-[#0B2E33] hover:text-[#4F7C82] transition-colors text-sm">
              → Calorie Calculator
            </Link>
