export const metadata = {
  title: 'Sleep Calculator - Best Sleep & Wake Times | Fruupy',
  ...
  keywords: 'fruupy, sleep calculator, sleep cycle, wake up time, bedtime calculator, sleep time, sleep tool, circadian rhythm, sleep schedule',
}
