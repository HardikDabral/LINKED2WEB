export const metadata = {
  title: 'QR Code Generator - Free QR Code Maker | Fruupy',
  ...
  keywords: 'fruupy, QR code generator, QR code maker, free QR code, QR code creator, generate QR code, QR code online, QR code tool, QR code scanner',
...
export default function QRLayout({ children }) {
  ...
  const breadcrumbData = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "QR Code Generator", "item": `${baseUrl}/tools/qr-generator` }
    ]
  }
