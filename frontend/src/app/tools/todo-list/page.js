...
const faqs = [
  { q: "Does my list persist after I close the browser?", a: "Yes. Tasks are stored in your browser’s local storage, so they remain on the same device. Clearing browser data will erase them." },
  { q: "Can I sync tasks between devices?", a: "No. Local storage stays on the device you created it on. For cross-device sync you would need a cloud to-do app with an account." },
  { q: "How do I mark a task done?", a: "Click the checkbox next to the task. Completed items are crossed out and can be hidden from the main list or deleted entirely." },
  { q: "Can I reorder tasks?", a: "Yes. Drag tasks up or down to reflect priority, or edit them in place to change the description." },
]
