export const metadata = {
  title: 'Age Calculator - Calculate Your Exact Age | Fruupy',
  ...
  keywords: 'fruupy, age calculator, calculate age, date of birth calculator, age in days, age in months, how old am I, birthday calculator, age finder, free age calculator',
...
export default function AgeLayout({ children }) {
  ...
  const breadcrumbData = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Age Calculator", "item": `${baseUrl}/tools/age-calculator` }
    ]
  }
