export const metadata = {
  title: 'Math Solver - Solve Equations Online | Fruupy',
  ...
  keywords: 'fruupy, math solver, equation solver, algebra calculator, math calculator, solve equations, quadratic solver, linear equations, math tool',
}
