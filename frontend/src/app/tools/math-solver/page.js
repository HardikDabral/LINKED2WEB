...
const faqs = [
  { q: "What kinds of equations can it solve?", a: "It handles arithmetic, percentages, basic algebra and common functions. More advanced problems (calculus, matrices) may need a dedicated algebra system." },
  { q: "Does it show solution steps?", a: "For supported equation types, the solver outlines the key steps so you can follow the method, not just the final answer." },
  { q: "Why did my equation return an error?", a: "Check for missing operators, mismatched brackets, or variables used but not defined. The solver expects standard math syntax like x^2 for powers and * for multiplication." },
  { q: "Is this a substitute for learning algebra?", a: "No. Use it to verify your work or unblock a homework problem, but practice solving by hand to build real fluency with the underlying methods." },
]
      ...
      <div className="max-w-2xl w-full mx-4 sm:mx-auto p-6 pt-16">
        ...
        <div className="mt-8 bg-white/50 backdrop-blur-xl rounded-xl p-6 shadow-md border border-[#93B1B5]/40">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <Link href="/tools/gpa-calculator" className="text-[#0B2E33] hover:text-[#4F7C82] transition-colors text-sm">
              → GPA Calculator
            </Link>
            <Link href="/tools/interest-calculator" className="text-[#0B2E33] hover:text-[#4F7C82] transition-colors text-sm">
              → Interest Calculator
            </Link>
