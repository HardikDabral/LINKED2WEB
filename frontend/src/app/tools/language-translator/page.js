...
const faqs = [
  { q: "How many languages are supported?", a: "The translator covers 50+ major languages. Pick a source and target from the dropdowns; if auto-detect is enabled, it infers the source from the input." },
  { q: "How accurate is the translation for long text?", a: "Short sentences and common phrases translate well. Long paragraphs, idioms, and technical content should be reviewed by a human speaker for nuance and terminology." },
  { q: "Does it work offline?", a: "No. The tool calls an online translation service to produce results, so an active internet connection is required." },
  { q: "Is my text stored?", a: "Text is sent to the translation provider for processing and is not persisted by this site. Avoid pasting confidential or personal data." },
]
