...
const faqs = [
  { q: "Can I record lap times?", a: "Yes. Press the lap button while the stopwatch is running to capture the split without stopping the main timer." },
  { q: "Does it keep running if I switch tabs?", a: "Yes. The stopwatch uses the real clock, so the elapsed time stays accurate even if the tab is in the background or your screen locks." },
  { q: "Are my times saved after I refresh?", a: "No. Elapsed time and laps live in the browser tab — refreshing or closing the tab resets them. Note down your laps before leaving." },
  { q: "How precise is the stopwatch?", a: "The display updates to a hundredth of a second, which is plenty for workouts, cooking and casual timing. Extremely precise lab timing still needs specialised hardware." },
]
  ...
  <div className="max-w-2xl w-full mx-4 sm:mx-auto p-6 pt-16">
        ...
        <div className="mt-8 bg-white/50 backdrop-blur-xl rounded-xl p-6 shadow-md border border-[#93B1B5]/40">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <Link href="/tools/age-calculator" className="text-[#0B2E33] hover:text-[#4F7C82] transition-colors text-sm">
              → Age Calculator
            </Link>
            <Link href="/tools/pomodoro" className="text-[#0B2E33] hover:text-[#4F7C82] transition-colors text-sm">
              → Pomodoro Timer
            </Link>
