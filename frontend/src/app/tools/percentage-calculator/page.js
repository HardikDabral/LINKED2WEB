...
const faqs = [
  { q: "How do I calculate X% of Y?", a: "Multiply Y by X/100. For example, 15% of 200 is 200 × 0.15 = 30. The calculator does this instantly for any combination." },
  { q: "How do I find a percentage increase?", a: "Subtract the old value from the new value, divide by the old value, and multiply by 100. The calculator automates this — just enter both values." },
  { q: "How do I calculate percentage decrease?", a: "The formula is the same as for increase, but the result will be negative when the new value is smaller. The tool labels the direction for clarity." },
  { q: "What if I have the result and want the percentage?", a: "Use the “what percent is X of Y” mode — divide X by Y and multiply by 100 to get the percentage X represents of Y." },
]
      ...
      <div className="max-w-2xl w-full mx-4 sm:mx-auto p-6 pt-16">
        ...
        <div className="mt-8 bg-white/50 backdrop-blur-xl rounded-xl p-6 shadow-md border border-[#93B1B5]/40">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <Link href="/tools/gst-calculator" className="text-[#0B2E33] hover:text-[#4F7C82] transition-colors text-sm">
              → GST Calculator
            </Link>
