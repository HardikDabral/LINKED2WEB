export const metadata = {
  title: 'Percentage Calculator - Calculate Percentages | Fruupy',
  ...
  keywords: 'fruupy, percentage calculator, percent calculator, calculate percentage, percentage tool, percent tool, percentage finder, percent converter',
...
export default function PercentageLayout({ children }) {
  ...
  const breadcrumbData = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Percentage Calculator", "item": `${baseUrl}/tools/percentage-calculator` }
    ]
  }
