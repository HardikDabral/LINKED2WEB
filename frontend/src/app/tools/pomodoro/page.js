...
const faqs = [
  { q: "What is the Pomodoro Technique?", a: "It is a time-management method where you work in focused 25-minute sprints (“pomodoros”) separated by 5-minute breaks, with a longer break after every four sprints." },
  { q: "Can I change the sprint and break lengths?", a: "Yes. The defaults follow the classic 25/5/15-minute rhythm, but you can customise all three durations to fit your attention span and task." },
  { q: "Does the timer run if I switch tabs?", a: "Yes — it is based on the real clock, so the countdown stays accurate even when the tab is backgrounded. A sound alerts you when each interval ends." },
  { q: "What should I do during breaks?", a: "Step away from the screen — stretch, hydrate, or walk briefly. Short movement breaks reset attention and help you return to deep work more easily." },
]
