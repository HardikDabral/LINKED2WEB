...
const faqs = [
  { q: "How are my daily calorie needs calculated?", a: "We estimate your Basal Metabolic Rate (BMR) using the Mifflin-St Jeor equation based on age, sex, height and weight, then multiply it by an activity factor to give your Total Daily Energy Expenditure (TDEE)." },
  { q: "What’s the difference between BMR and TDEE?", a: "BMR is the calories your body burns at complete rest. TDEE includes BMR plus calories burned from movement, exercise and digestion — it is the number most people follow for weight goals." },
  { q: "How many calories should I eat to lose weight?", a: "A moderate deficit of 300–500 kcal below your TDEE typically yields steady, sustainable fat loss of about 0.25–0.5 kg per week. Larger deficits are harder to sustain and may reduce muscle mass." },
  { q: "Is the result medical advice?", a: "No. It is a general estimate and does not replace personalised guidance. Consult a qualified dietitian or doctor for nutrition plans tied to medical conditions." },
]
      ...
      <div className="max-w-2xl w-full mx-4 sm:mx-auto p-6 pt-16">
        ...
        <div className="mt-8 bg-white/50 backdrop-blur-xl rounded-xl p-6 shadow-md border border-[#93B1B5]/40">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link href="/tools/bmi-calculator" className="text-[#0B2E33] hover:text-[#4F7C82] transition-colors text-sm">
              → BMI Calculator
            </Link>
            <Link href="/tools/water-intake-calculator" className="text-[#0B2E33] hover:text-[#4F7C82] transition-colors text-sm">
              → Water Intake Calculator
            </Link>
            <Link href="/tools/sleep-calculator" className="text-[#0B2E33] hover:text-[#4F7C82] transition-colors text-sm">
              → Sleep Calculator
            </Link>
