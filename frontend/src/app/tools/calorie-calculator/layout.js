export const metadata = {
  title: 'Calorie Calculator - Daily Calorie Needs Calculator | Fruupy',
  ...
  keywords: 'fruupy, calorie calculator, daily calories, calorie needs, BMR calculator, TDEE calculator, calorie intake, weight loss calculator, calorie counter',
...
export default function CalorieLayout({ children }) {
  ...
  const breadcrumbData = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Calorie Calculator", "item": `${baseUrl}/tools/calorie-calculator` }
    ]
  }
