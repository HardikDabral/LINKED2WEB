...
const faqs = [
  { q: "What is Base64 encoding?", a: "Base64 converts binary or text data into an ASCII-safe string using 64 characters (A–Z, a–z, 0–9, + and /). It is widely used to embed images, transfer data in URLs, and carry payloads through text-only channels." },
  { q: "Is Base64 a form of encryption?", a: "No. Base64 is encoding, not encryption — anyone can decode it instantly. Never use it to protect passwords, tokens, or personal data." },
  { q: "Why does my decoded text look garbled?", a: "The input may not be valid Base64, may include extra whitespace or padding, or may have been encoded in a different character set. Make sure the input is trimmed and was originally UTF-8." },
  { q: "Does Base64 increase file size?", a: "Yes. Base64 output is roughly 33% larger than the original binary because every 3 bytes are encoded as 4 ASCII characters." },
]
