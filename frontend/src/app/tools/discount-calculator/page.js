...
const faqs = [
  { q: "How do I calculate the sale price after a discount?", a: "Enter the original price and the discount percentage; the tool subtracts the discount value and shows both the savings and the final price you pay." },
  { q: "How do I find the original price from a discounted amount?", a: "If you know the final price and the discount percentage, the calculator reverses the math to reveal the original (pre-discount) price." },
  { q: "Can I stack multiple discounts?", a: "Stacked discounts multiply, not add. A 20% off followed by 10% off equals 28% off (not 30%). Apply discounts one at a time to see the true stacked price." },
  { q: "Does this include tax?", a: "No. The calculator works on pre-tax amounts. Add sales tax or GST separately after the discount using our GST calculator if needed." },
]
