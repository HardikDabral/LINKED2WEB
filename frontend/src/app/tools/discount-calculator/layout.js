export const metadata = {
  title: 'Discount Calculator - Calculate Discounts & Savings | Fruupy',
  ...
  keywords: 'fruupy, discount calculator, sale calculator, percentage off, discount price, savings calculator, price calculator, discount tool, sale price',
...
export default function DiscountLayout({ children }) {
  ...
  const breadcrumbData = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Discount Calculator", "item": `${baseUrl}/tools/discount-calculator` }
    ]
  }
