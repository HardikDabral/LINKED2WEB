...
const faqs = [
  { q: "How are days counted between two dates?", a: "We compute the absolute difference in calendar days between the start and end dates, ignoring time zones and accounting for leap years automatically." },
  { q: "Does the result include weekends?", a: "Yes. The total count includes every calendar day — weekdays and weekends. If you need only business days, subtract weekends manually or filter holidays." },
  { q: "Can the start date be after the end date?", a: "You can enter dates in either order. The tool reports the absolute number of days, so the result is always a positive number." },
  { q: "Are time zones considered?", a: "The counter works on calendar dates, not times. A trip across time zones won’t change the day difference as long as the calendar dates you enter are correct." },
]
