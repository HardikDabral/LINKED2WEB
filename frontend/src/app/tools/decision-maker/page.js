...
const faqs = [
  { q: "How does the decision maker pick an option?", a: "It uses the browser’s cryptographically-seeded random number generator to pick uniformly from the options you enter — every choice has an equal chance." },
  { q: "Can I add my own options?", a: "Yes. Enter any number of custom options; the picker chooses from exactly what you provide. You can remove or edit entries before spinning again." },
  { q: "Is the pick truly random?", a: "For everyday decisions, yes. It uses the browser’s secure random source, which is suitable for games, raffles and low-stakes choices. It is not intended for cryptographic use." },
  { q: "Can I get the same option twice in a row?", a: "Yes — each run is independent. Getting the same option multiple times is normal and expected with truly random selection." },
]
  ...
  <div className="max-w-2xl w-full mx-4 sm:mx-auto p-6 pt-16">
        ...
        <div className="mt-8 bg-white/50 backdrop-blur-xl rounded-xl p-6 shadow-md border border-[#93B1B5]/40">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link href="/tools/random-name-picker" className="text-[#0B2E33] hover:text-[#4F7C82] transition-colors text-sm">
              → Random Name Picker
            </Link>
